                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                <div class="form-mix-icon-input form-size-lg">
                                                    <select class="form-select js-choice" data-search-enabled="true">
                                                        ...
                                                        <option>Green Hills Hotel, Nyeri</option>
                                                        <option>Alba Hotel, Meru</option>
                                                        <option>Sarova Maiyan, Nanyuki</option>
                                                        <option>Oriental Palace, Embu</option>
                                                    </select>
                                                    <!-- Icons -->
                                                    <span class="position-absolute top-50 start-0 translate-middle ps-5"><i
                                ...
                                <div class="bg-light rounded-3 position-relative p-4 p-sm-5">
                                    ...
                                    <div class="row align-items-center position-relative">
                                        <div class="col-lg-8">
                                            <!-- Title -->
                                            <div class="d-flex">
                                                <h3>It's time to discover the best of venues</h3>
                                                <img src="assets/images/Locations/location.svg" class="h-100px w-100px ms-3" alt="">
                                            </div>
                                            <p class="mb-3 mb-lg-0">Host an event with us and get the best service.
                                            </p>
                                        </div>
                                        <!-- Content and input -->
