			...
			<div class="col-12">
				<div class="card bg-light p-0 pb-0">
					...
					<div class="card-body d-flex justify-content-between flex-wrap">
						...
						<div>
							<!-- Badge -->
							<div class="badge text-bg-dark"><i class="fa-solid fa-spa fa-fw text-warning"></i> Hotel</div>
							<div class="badge text-bg-dark"><i class="bi bi-scissors fa-fw text-warning"></i> Nyeri</div>
							<div class="badge text-bg-dark"><i class="fas fa-star fa-fw text-warning"></i> 4.6</div>
							
							<!-- Title -->
							<h1 class="h3 mt-2 mb-1">Green Hills Hotel</h1>
							<p class="mb-2 mb-sm-0"><i class="bi bi-geo-alt me-1 text-primary"></i>Nyeri</p>Nanyuki Highway, Chaka</p>
						</div>
						<!-- Buttons -->
					...
					<div class="col-lg-7 col-xl-8">
						...
						<div class="card bg-transparent mb-4">
                            ...
                            <div class="card-body px-0 pb-0">
                                <p class="mb-3">Green Hills Hotel is a luxurious hotel located in the beautiful city of Nyeri, Kenya. With its stunning architecture and breathtaking views, it offers a truly unforgettable experience for its guests. The hotel boasts spacious and elegantly designed rooms, equipped with modern amenities to ensure a comfortable stay. Guests can indulge in a wide range of facilities and services, including a swimming pool, spa, and fitness center. The hotel's restaurant serves delicious local and international cuisine, prepared by skilled chefs. Whether you're traveling for business or leisure, Green Hills Hotel is the perfect choice for a memorable stay in Nyeri.</p>

                                <p class="mb-0">Experience the warmth and hospitality of the staff, who are dedicated to providing exceptional service and making your stay truly enjoyable. Explore the nearby attractions, such as Mount Kenya National Park and Aberdare National Park, or simply relax and unwind in the hotel's serene surroundings. Green Hills Hotel is the ideal destination for those seeking luxury, comfort, and tranquility in the heart of Nyeri, Kenya.</p>
                            </div>
						</div>
						<!-- Card END -->
								...
								<ul class="list-group list-group-borderless my-3">
									...
									<li class="list-group-item">
										<a href="#" class="h6 fw-normal mb-0">
											<i class="bi fa-fw bi-geo-alt me-2"></i>Nanyuki Highway, Chaka
										</a>
									</li>
									<!-- Call no -->
									<li class="list-group-item">
										<a href="#" class="h6 fw-normal mb-0">
											<i class="bi fa-fw bi-telephone-forward me-2"></i>+254 123 456 789
										</a>
									</li>
									<!-- Email -->
									<li class="list-group-item">
										<a href="#" class="h6 fw-normal mb-0">
											<i class="bi fa-fw bi-envelope me-2"></i>info@greenhillshotel.com
										</a>
									</li>
								</ul>
								<!-- Social button -->
