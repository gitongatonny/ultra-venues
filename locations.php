...
<html lang="en">
    ...
    <head>
        <title>Locations | Ultra Venues</title>
                ...
                <div class="container">
                    ...
                    <div class="row mb-4">
                        <div class="col-12 text-center">
                            <h2 class="mb-0">Our Locations</h2>
                        </div>
                    </div>
                                ...
                                <div class="card-img-scale-wrapper rounded-3">
                                    ...
                                    <div class="card-img-overlay d-flex flex-column z-index-1 p-4">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <span class="badge text-bg-dark">Tropical Climate</span>
                                            <span class="badge text-bg-white"><i class="fa-solid fa-star text-warning me-2"></i>4.3</span>
                                        </div>
                                        <!-- Card overlay bottom -->
                                        <div class="w-100 mt-auto">
                                            <!-- Card category -->
                                            <span class="badge text-bg-white fs-6">20 Venues</span>
                                        </div>
                                    </div>
                                </div> 
