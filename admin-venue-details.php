					...
					<div class="row g-4 mb-4">
						<div class="col-lg-4">
							<div class="card card-body border border-primary bg-primary bg-opacity-10 border-opacity-25 p-4 h-100">
								<div class="d-flex justify-content-between align-items-center">
									<div>
										<h3 id="total-amenities" class="mb-0 fw-bold"></h3>
						...
						<div class="col-lg-4">
							<div class="card card-body border border-warning bg-warning bg-opacity-10 border-opacity-25 p-4 h-100">
								<div class="d-flex justify-content-between align-items-center">
									<div>
										<h3 id="bookings-this-month" class="mb-0 fw-bold"></h3>
						...
						<div class="col-lg-4">
							<div class="card card-body border border-success bg-success bg-opacity-10 border-opacity-25 p-4 h-100">
								<div class="d-flex justify-content-between align-items-center">
									<div>
										<h3 id="earnings-this-month" class="mb-0 fw-bold"></h3>
							...
							<div class="card bg-light">
								<div class="dropdown position-absolute top-0 end-0 m-3">
									...
									<ul class="dropdown-menu dropdown-w-sm dropdown-menu-end min-w-auto shadow rounded" aria-labelledby="dropdownShare1">
										<li><a class="dropdown-item" href="#"><i class="bi bi-trash fa-fw me-2"></i>Remove Venue</a>
										</li>
									</ul>
								</div>
								<div class="card-body text-center">
									<div class="avatar avatar-xl flex-shrink-0 mb-3">
										<img id="venue-avatar" class="avatar-img rounded-circle" src="assets/images/mt-kenya.jpg" alt="avatar">
									</div>
									<h5 id="venue-name" class="mb-2"></h5>
								...
								<div class="card-footer bg-light border-top">
									...
									<div class="d-flex align-items-center mb-3">
										...
										<div class="ms-2">
											...
											<h6 id="venue-email" class="fw-normal small mb-0"><a href="#"></a></h6>
										</div>
									</div>
									<div class="d-flex align-items-center mb-3">
										...
										<div class="ms-2">
											<small>Phone</small>
											<h6 id="venue-phone" class="fw-normal small mb-0"><a href="#"></a></h6>
										</div>
									</div>
									<div class="d-flex align-items-center mb-3">
										...
										<div class="ms-2">
											<small>Address</small>
											<h6 id="venue-address" class="fw-normal small mb-0"></h6>
										</div>
									</div>
								</div>
							</div>
										...
										<div class="col-md-6">
											<ul class="list-group list-group-borderless">
												<li class="list-group-item mb-3">
													...
													<span id="venue-info-name" class="h6 fw-normal ms-1 mb-0"></span>
												</li>
												<li class="list-group-item mb-3">
													<span>Phone:</span>
													<span id="venue-info-phone" class="h6 fw-normal ms-1 mb-0"></span>
												</li>
												<li class="list-group-item mb-3">
													<span>Venue Government License:</span>
													<span id="venue-license" class="h6 fw-normal ms-1 mb-0"></span>
												</li>
												<li class="list-group-item mb-3">
													<span>KRA PIN:</span>
													<span id="venue-pin" class="h6 fw-normal ms-1 mb-0"></span>
												</li>
											</ul>
										</div>
										<div class="col-12">
											<ul class="list-group list-group-borderless">
												<li class="list-group-item">
													...
													<p id="venue-description" class="h6 fw-normal mb-0">
													</p>
												</li>
											</ul>
										</div>
