			...
			<div class="card shadow">
				...
				<div class="card-header border-bottom d-sm-flex justify-content-between align-items-center">
					...
					<div class="d-flex align-items-center flex-shrink-0">
						...
						<!-- Info -->
						<div class="ms-3">
							<h5 class="mb-0">Finish Us Junior</h5></h5>
						</div>
					</div>

					<div class="d-block d-lg-flex gap-lg-5 flex-wrap mt-3 mt-lg-0">
						<!-- Email address -->
						<h6 class="mb-2 mb-lg-0"><i class="bi bi-envelope-fill fa-fw me-1"></i>Email Address:<a href="#" class="fw-normal"> finny@real.com</a></h6>
						<!-- Email address -->
						<h6 class="mb-0"><i class="bi bi-headset fa-fw me-1"></i>Contact no:<a href="#" class="fw-normal"> +254-700-123-555</a></h6>
					</div>
				</div>
				...
				<div class="card-body">
					...
					<div class="bg-light rounded p-3 d-none d-lg-block">
						<div class="row row-cols-6 justify-content-between g-4">
							...
							<div class="col"><h6 class="mb-0">Venue Type</h6></div>
					...
					<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-6 g-2 g-sm-4 align-items-md-center justify-content-between border-bottom px-2 py-4">
						...
						<div class="col">
							...
							<div class="d-flex align-items-center">
								...
								<div class="w-80px flex-shrink-0">
									<img src="assets/images/mt-kenya.jpg" class="rounded" alt="">
								</div>
								<!-- Title -->
								<h6 class="mb-0 ms-2">Green Hills Hotel</h6>
							</div>
						</div>	
						...
						<div class="col">
							...
							<h6 class="mb-0 fw-normal">Hotel</h6>
						</div>

						<!-- Data item -->
						<div class="col">
							<small class="d-block d-lg-none">Start Date:</small>
							<h6 class="text-success mb-0">22 Nov 2024</h6>
						</div>

						<!-- Data item -->
						<div class="col">
							<small class="d-block d-lg-none">End Date:</small>
							<h6 class="text-success mb-0">23 Nov 2024</h6>
						</div>

						<!-- Data item -->
						<div class="col"><a href="admin-venue-details.php" class="btn btn-sm btn-light mb-0">View</a></div>
					</div>
