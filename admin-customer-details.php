...
<head>
	<title>Admin Customers Details | Ultra Venues</title>
...
<body>
				...
				<div class="card shadow">
					...
					<div class="card-header border-bottom d-sm-flex justify-content-between align-items-center">
						...
						<div class="d-flex align-items-center flex-shrink-0">
							...
							<!-- Info -->
							<div class="ms-3">
								<h5 class="mb-0" id="userName">Loading Name...</h5>
							</div>
						</div>
						...
						<div class="d-block d-lg-flex gap-lg-5 flex-wrap mt-3 mt-lg-0">
							...
							<h6 class="mb-2 mb-lg-0">
								<i class="bi bi-envelope-fill fa-fw me-1"></i>Email Address:
								<a href="#" class="fw-normal" id="userEmail">loading@loading.com</a>
							</h6>
							<!-- Contact number -->
							<h6 class="mb-0">
								<i class="bi bi-headset fa-fw me-1"></i>Contact no:
								<a href="#" class="fw-normal" id="userContact">+000-000-0000</a>
							</h6>
						</div>
					</div>
					...
					<div class="card-body">
						...
						<div id="bookingHistory" class="booking-history">
							<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-6 g-2 g-sm-4 align-items-md-center justify-content-between border-bottom px-2 py-4">
								<div class="col">
									<small class="d-block d-lg-none">Venue Name:</small>
									<div class="d-flex align-items-center">
										<!-- Image -->
										<div class="w-80px flex-shrink-0">
											<img src="assets/images/placeholder.jpg" class="rounded" alt="">
										</div>
										<!-- Title -->
										<h6 class="mb-0 ms-2">Loading Venue...</h6>
									</div>
								</div>
								<div class="col">
								...
								<div class="col">
									...
									<h6 class="text-success mb-0">Loading...</h6>
								</div>
								<div class="col">
	...
	<script>
		document.addEventListener("DOMContentLoaded", function() {
			...
			// Fetch user details
			fetch(`http://localhost:5000/api/admin/customers/${userId}`)
				...
				.then(bookings => {
					...
					bookings.forEach(booking => {
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-6 g-2 g-sm-4 align-items-md-center justify-content-between border-bottom px-2 py-4">
                            ...
                            <div class="col">
                                <small class="d-block d-lg-none">Start Date:</small>
                                <h6 class="text-success mb-0">${formatDate(booking.startDate) || 'N/A'}</h6>
                            </div>
                            <div class="col">
                                <small class="d-block d-lg-none">End Date:</small>
                                <h6 class="text-success mb-0">${formatDate(booking.endDate) || 'N/A'}</h6>
                            </div>
                            <div class="col">
                                <a href="admin-venue-details.php" class="btn btn-sm btn-light mb-0">View</a>
                            </div>
                        </div>
                    `;
						bookingHistory.insertAdjacentHTML('beforeend', bookingRow);
					});
				})
