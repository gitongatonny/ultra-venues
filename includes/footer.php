		...
		<div class="container">
			...
			<div class="row g-4">
				...
				<div class="col-lg-3">
					...
					<p class="my-3 text-muted">Get the Best</p>
			...
			<div class="row g-4 justify-content-between mt-0 mt-md-2">
				...
				<div class="col-sm-7 col-md-6 col-lg-4">
					...
					<ul class="list-inline mb-0 mt-3">
						<li class="list-inline-item"> <a href="#"><img src="assets/images/element/mpesa.png" class="h-30px" alt=""></a></li>
			...
			<div class="row">
				<div class="container">
					<div class="d-lg-flex justify-content-between align-items-center py-3 text-center text-lg-start">
						<!-- copyright text -->
						<div class="text-muted text-primary-hover"> Copyrights ©2024 Ultra-Venues. Built by <a href="#" class="text-muted">Dev-KE</a>. </div>
						<!-- copyright links-->
