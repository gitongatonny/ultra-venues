...
<head>
	<title>Admin Venues List | Ultra Venues</title>
	...
	<main>
		...
		<div class="page-content">
			...
			<div class="page-content-wrapper p-xxl-4">
				...
				<div class="row">
					<div class="col-12 mb-4 mb-sm-5">
						<div class="d-sm-flex justify-content-between align-items-center">
							<h1 class="h3 mb-3 mb-sm-0">Venues List</h1>
				...
				<!-- Venue list START -->
				<div id="venue-list" class="row g-4"></div>
				<!-- Venue list END -->
	...
	<script>
		document.addEventListener("DOMContentLoaded", async () => {
                ...
                <div class="col-md-6 col-lg-4 col-xxl-3">
                    <div class="card border h-100">
                        <div class="dropdown position-absolute top-0 end-0 m-3">
                            <a href="#" class="btn btn-sm btn-light btn-round small mb-0" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="card-body text-center pb-0">
                            ...
                            <div class="d-flex justify-content-between mt-3">
                                <h6 class="mb-0 small"><span class="fw-light">Total Bookings:</span> ${venue.bookings == null? 0: venue.bookings}</h6>
                                <h6 class="mb-0 small">${venue.rating == null? "No ratings" : venue.rating}<i class="fa-solid fa-star text-warning ms-1"></i></h6>
                            </div>
                        </div>
                        <div class="card-footer d-flex gap-3 align-items-center">
                            <a href="admin-venue-details.php?id=${venue.id}" class="btn btn-sm btn-primary-soft mb-0 w-100">View detail</a>
            ...
            `;
				...
				venueList.innerHTML = '<p class="text-danger">Could not load venues at this moment.</p>';
			}
		});
	</script>
