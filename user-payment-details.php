...
<html lang="en">
    ...
    <head>
        <title>My Payment Details | Ultra Venues</title>
								...
								<div class="card">
									<div class="bg-danger p-4 rounded-3">
										<div class="d-flex justify-content-between align-items-start">
											...
											<!-- Card action START -->
											<div class="dropdown">
												<a class="text-white" href="#" id="creditcardDropdown2" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
													<!-- Dropdown Icon -->
													<svg width="24" height="24" fill="none">
														<circle fill="currentColor" cx="12.5" cy="3.5" r="2.5"></circle>
														<circle fill="currentColor" opacity="0.5" cx="12.5" cy="11.5" r="2.5"></circle>
